...
public class PythonExecutor implements Executor {
    ...
    public ExecutionResult execute(ExecutionRequest request) {
        ...
        try {
            ...
            log.error("Python execution failed for submission {}", request.getSubmissionId(), e);
            return ExecutionResult.builder()
    ...
    @Override public String getCompileCommand() { return null; }
    @Override public String getRunCommand() { return "python /tmp/solution.py"; }
}
